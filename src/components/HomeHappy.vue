<template>
  <div
    class="bg-[url('/img/bg-02.png')] bg-no-repeat bg-center bg-cover bg-[rgba(0,54,110,0.05)] py-16"
  >
    <div class="container">
      <div class="md:flex justify-center items-center md:space-x-8">
        ...
        <div
          ...
          data-aos="fade"
        >
          <h4 class="text-xl lg:text-3xl font-bold mb-6">Make a child happy</h4>
          <p class="lg:text-lg">
            Arete organizes annual free bootcamps to cater for underprivileged
